	...
	*/
	...
	/*	[5-5] 다음은 1과 9사이의 중복되지 않은 숫자로 이루어진 3자리 숫자를 만들어내는 프
		...
		*/
		...
		// 배열 ballArr의 앞에서 3개의 수를 배열 ball3로 복사한다.
		 	//(2)
			System.arraycopy(ballArr, 1, ball3, 1, 3);
		*/
		...
		라. 단, 가능한 한 적은 수의 동전으로 거슬러 주어야 한다. (1)에 알맞은 코드를 넣어서
		프로그램을 완성하시오.
		...
		*/
		...
		전체 3문제 중 2문제 맞추셨습니다.		
			...
			String[][] words = {
				...
				{"inteqer","정수"}		// words[2][0], words[2][1]
		};
		...
		for(int i = 0; i < words.length; i++){
			...
			}System.out.println("전체 " + count + "문제 중 " + ran + "문제 맞추셨습니다.");
		}
