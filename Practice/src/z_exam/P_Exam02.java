...
public class P_Exam02 {
	
	public static void main(String[] args) {
		
/*		[2-1] 다음 표의 빈 칸에 개의 기본형(primitive type)을 알맞은 자리에 넣으시오.
		...
		[2-2] 주민등록번호를 숫자로 저장하고자 한다. 이 값을 저장하기 위해서는 어떤 자료형(date type)을 선택해야 할까?
		...
		[2-8] 참조형 변수 와 같은 크기의 기본형(primitive type)은? (  )
		a. int
		b. long
		c. short
		d. float
