...
public class BookFindSearchServiceImpl implements BookFindSearchService {
	...
	SPListService spListService = SPListServiceImpl.getInstance();
...
//					this.bookNumber = book1.getBookNumber();
		...
		System.out.println("==================================================");
		System.out.println("1.장바구니 담기 / 2.리뷰보기 / 0.재검색 / -1.메인화면");	//-1.메인화면(로그인 이후)
		System.out.println("==================================================");
		System.out.print("메뉴에 해당하는 번호 입력> ");
			...
			case 1://장바구니 담기
				...
				break;
			case 2://리뷰보기
				reviewService.ReviewFind(this.bookNumber);
				break;
			case -1://메인화면(로그인 이후)
//				guestController.userMenu();
				break;
...
//		
		...
		System.out.println("==================================================");
		System.out.println("1.장바구니 확인 / 0.메인화면 ");
		System.out.println("==================================================");
		System.out.print("메뉴에 해당하는 번호 입력> ");
